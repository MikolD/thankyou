...
if (isset($_POST["addgiver"])) {
    $addgiverquery = "INSERT INTO givers(email,name,gender,phone,department,workID,placeofWork,branch) values('$_POST[email]','$_POST[fullName]','$_POST[gender]','$_POST[phoneNumber]','$_POST[department]','$_POST[workid]','$_POST[placeofwork]','$_POST[branch]')";
